...
exports.JwtAuthGuard = exports.jwtAuthExecutionContext = void 0;
...
var JwtAuthGuard = function () {
    ...
    var JwtAuthGuard = _classThis = /** @class */ (function (_super) {
        ...
        JwtAuthGuard_1.prototype.canActivate = function (context) {
            ...
            exports.jwtAuthExecutionContext = context; // Store the ExecutionContext in the static variable
            return _super.prototype.canActivate.call(this, context);
        };
        JwtAuthGuard_1.prototype.handleRequest = function (err, isAuthenticated, info) {
            console.log('err', err);
            ...
            if (err || !isAuthenticated) {
                if (info && info.message) {
                    if (info.message === 'No auth token') {
                        throw new exceptions_1.UnauthorizedException('MISSING_AUTH_TOKEN');
                    }
                    else if (info.message === 'invalid signature') {
                        throw new exceptions_1.UnauthorizedException('INVALID_TOKEN');
                    }
                    else if (info.message === 'jwt expired') {
                        throw new exceptions_1.UnauthorizedException('EXPIRED_TOKEN');
                    }
                }
